...
return [
    ...
    */
    ...
    'attributes'           => [
        //
        'steal.date' => 'Дата викрадення',
        'steal.data' => 'Деталі викрадення',
        'steal.coordinates' => 'Координати викрадення',
        'see.date' => 'Дата',
        'see.data' => 'Деталі',
        'see.coordinates' => 'Координати',
        'see.email' => 'Емейл',
        'maker' => 'виробник',
        'color' => 'колір',
        'model' => 'модель',
        'number_frame' => 'номер рами',
        'photo' => 'фото',
        'place.village' => 'мікрорайон/село',
        'place.area' => 'регіон',
        'place.region' => 'область',
        'type_frame' => 'тип рами',
        'diametr' => 'діаметр коліс',
        'brakes' => 'гальма',
        'front_fork' => 'передня вилка',
        'date_production' => 'дата виготовлення',
        'more_information' => 'додатково'
    ],
